...
class CameraViewModelTest {
    ...
    private lateinit var calculateObjectSize: CalculateObjectSizeUseCase
    private lateinit var findBestReference: FindBestReferenceUseCase
    ...
    fun setup() {
        ...
        calculateObjectSize = CalculateObjectSizeUseCase()
        findBestReference = FindBestReferenceUseCase()
